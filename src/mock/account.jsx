export const mockAccounts = [
  { id: 1, email: "account1@example.com", username: "John Doe", password: "password1", role: "admin" },
  { id: 2, email: "account2@example.com", username: "Alice Smith", password: "password2", role: "user" },
  { id: 3, email: "account3@example.com", username: "Bob Johnson", password: "password3", role: "user" },
  { id: 4, email: "account4@example.com", username: "Charlie Brown", password: "password4", role: "user" },
  { id: 5, email: "account5@example.com", username: "David Lee", password: "password5", role: "user" },
  { id: 6, email: "account6@example.com", username: "Eve White", password: "password6", role: "user" },
  { id: 7, email: "account7@example.com", username: "Frank Green", password: "password7", role: "user" },
  { id: 8, email: "account8@example.com", username: "Grace Hopper", password: "password8", role: "user" },
  { id: 9, email: "account9@example.com", username: "Hank Pym", password: "password9", role: "user" },
  { id: 10, email: "account10@example.com", username: "Ivy Blue", password: "password10", role: "user" }
];
